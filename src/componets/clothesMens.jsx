...
const FilterProductsMens = ()=>{
  ...
  const MensFilter = products.filter((products)=> products.category === "men's clothing"  )
...
export default FilterProductsMens;